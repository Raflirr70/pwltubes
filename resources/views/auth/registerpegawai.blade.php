<x-guest-layout>
    <form method="POST" action="{{ route('registerpegawai') }}">
        @csrf
        ...
        <div>
            ...
            <select id="role" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="role" required>
                ...
                @endif
                    ...
                    <option value="5">PJ Gudang</option>
            </select>
        ...
        @if(Auth::user()->id_role == 1)
            <div>
                ...
                <select id="kota" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="kota" required>
        ...
        @else
            <x-text-input id="kota" class="hidden" type="text" name="kota" :value="auth()->user()->id_toko" />
        @endif
